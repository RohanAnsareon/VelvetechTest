        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UniqueStudentId = table.Column<string>(maxLength: 16, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Students_UniqueStudentId",
                table: "Students",
                column: "UniqueStudentId",
                unique: true,
                filter: "[UniqueStudentId] IS NOT NULL");
        }
